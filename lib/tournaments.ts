...
export const TOURNAMENTS: TournamentMeta[] = [
  ...
  { year: 2010, nameKo: "남아공", host: "남아프리카공화국", available: true },
  { year: 2014, nameKo: "브라질", host: "브라질", available: true },
  { year: 2018, nameKo: "러시아", host: "러시아", available: true },
  { year: 2022, nameKo: "카타르", host: "카타르", available: true },
  { year: 2026, nameKo: "북중미", host: "미국 · 캐나다 · 멕시코", available: true },
];
